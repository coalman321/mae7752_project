...
class IKExecutorNode: public rclcpp::Node{
  ...
  void planRun(){
    ...
    startingPose.orientation.w = 0.707;
    startingPose.orientation.x = 0.0;
    startingPose.orientation.y = 0.707;
    startingPose.orientation.z = 0.0;
    startingPose.position.x = -0.055;
    startingPose.position.y = 0.735;
    startingPose.position.z = 0.25;

    geometry_msgs::msg::Pose endingPose;
    endingPose.orientation.w = 0.707;
    endingPose.orientation.x = 0.0;
    endingPose.orientation.y = 0.707;
    endingPose.orientation.z = 0.0;
    endingPose.position.x = -0.055;
    endingPose.position.y = -0.560;
